...
for start_city in range(n):
    ...
    for iteration in range(num_iterations):
        ...
        for ant in range(num_ants):
            current_tour = [start_city]  # Start from the specified city
    ...
    # Print the best tour and its total distance for the current starting point
    print(f"Starting from City {start_city}, Best Tour (City Indices): {best_tour}")
    print(f"Starting from City {start_city}, Total Distance (in kilometers): {best_distance}")
