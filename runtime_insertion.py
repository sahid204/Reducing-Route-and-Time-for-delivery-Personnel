...
tour = [0]
unvisited_cities = list(range(1, n))  # All other cities are unvisited

# Create a function to perform the insertion algorithm
def insertion_algorithm():
...
execution_time = timeit.timeit(insertion_algorithm, number=1)

# Calculate the total distance of the tour
total_distance = sum(distance_matrix[tour[i]][tour[i + 1]] for i in range(n - 1))
...
print("Algorithm Execution Time: {:.6f} seconds".format(execution_time))
